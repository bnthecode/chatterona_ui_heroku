  ...
  const LinkDialog = () => {
    return (
      ...
      >
        ...
        <DialogActions>
          <Button onClick={navigateToNewPage} className={classes.footerButton}>
            Proceed
          </Button>
        </DialogActions>
      </Dialog>
  ...
  return (
    <Paper elevation={2} onClick={toggleDialog} className={classes.link}>
      <div className={classes.linkBody}>
        ...
        <Typography style={{ marginTop: 8, fontWeight: 600 }}>
          {" "}
          {displayContent("site")}
        </Typography>
      </div>
      <div className={classes.linkBody2}>
        {content.img && (
          <img
            alt="Message link"
            src={content.img}
            style={{ maxHeight: "300px", maxWidth: "400px", marginTop: 8 }}
          />
        )}
